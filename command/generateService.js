...
workbook.xlsx.readFile(filePath)
    .then(function () {
        ...
        resultString = 'var service = ' + resultString + '\n' + 'module.exports = service;';
        resultString = 'var Q = require("q");' + '\n' + resultString
        resultString = 'var countPage = require(\'./countPage\');' + '\n' + resultString
        resultString = 'var model = require(\'../repository/mysql/model\');' + '\n' + resultString
